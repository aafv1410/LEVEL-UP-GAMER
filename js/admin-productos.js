...
const products = JSON.parse(localStorage.getItem('products')) || [
    { id: "CAT01", name: "Catan", category: "Juegos de Mesa", price: 29990, description: "Un clásico juego de estrategia...", image: "img/catan.png", stock: 15, stockCritico: 5 },
    { id: "CAR01", name: "Carcassonne", category: "Juegos de Mesa", price: 24990, description: "Un juego de colocación de fichas...", image: "img/carcasonne.png", stock: 20, stockCritico: 5 },
    { id: "XBX01", name: "Controlador Xbox Series X", category: "Accesorios", price: 59990, description: "Ofrece una experiencia de juego cómoda...", image: "img/control.png", stock: 10, stockCritico: 3 },
];
